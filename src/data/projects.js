export const ROOM_HALF_X = 5.2;
export const ROOM_HALF_Z = 4.2;
...
export const DESK_POSITION = [-4.6, 0, -0.5];
export const DESK_ROTATION_Y = Math.PI / 2;
export const SPAWN_POSITION = [0, 0, 2.0];

export const CHAIR_POSITION = [-3.75, 0, -0.5];
...
export const WINDOW_POSITION = [1.6, 1.5, -ROOM_HALF_Z + 0.05];
...
export const PIANO_POSITION = [2.7, 0, 2.2];
